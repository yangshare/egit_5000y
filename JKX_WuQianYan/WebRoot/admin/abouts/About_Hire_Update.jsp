...
.css_td {
  ...
  if(request.getParameter("update")!=null){
   ...
   out.print("<script>alert('招聘信息更新失败！');</script>");
  }
  }
  int id = Integer.parseInt(request.getParameter("id")); 
  Web_About_Hire_Impl hireImpl=new Web_About_Hire_Impl();
  ArrayList<Web_About_Hire_Impl> Alist = new Web_AllImpl_DoAll(hireImpl).QueryById("w_about_hire",id);
  hireImpl=Alist.get(0);
 // pageContext.setAttribute("caseType",newsImpl.getTypeName());
   %>
  <body> 
   ...
   <td height="15" class="css_td">
           招聘标题：
   <input type="text" id="hireName" name="hireName" class="input_01" value="<%=hireImpl.getHireName()%>"/>
   </td>
   </tr>
   ...
   <td height="15 class="css_td">
        &nbsp;招聘时间：
   <input type="text" id="hireTime" name="hireTime" class="input_01" value="<%=hireImpl.getHireTime()%>"/>
   </td>
   </tr>
   ...
   <td height="15 class="css_td">
        &nbsp;招聘简介：
   <input type="text" id="hireExplain" size="50" maxlength="50" name="hireExplain" class="input_01" value="<%=hireImpl.getHireExplain()%>"/>
   </td>
   </tr>
   ...
   <td height="15 class="css_td">
        &nbsp;招聘点击量：
   <input type="text" id="hireClicks" name="hireClicks" class="input_01" value="<%=hireImpl.getHireClicks()%>" readonly="readonly"/>
   </td>
   </tr>
...
<input type="file" border="0" id="myFile" name="myFile" value="选择" size="5" onchange="javascript:mit();">
 <input type="hidden" name="hireImg" value="<%=hireImpl.getHireImg()%>"> <br/>
 <center>
 <img src="<%=basePath%>/admin/images/loading.gif"  id="loading" style="display: none;">
   ...
   <td height="60" class="css_td">
       招聘内容：
   <br/><br/><textarea name="content" id="textarea" class="input_01"><%=hireImpl.getHireText()%></textarea>  
   </td>
   </tr>
   ...
   <script type="text/javascript" defer="defer">
    ...
    window.onload = function(){
     ...
     function submi(){
       ...
       var hireExplain=document.getElementById("hireExplain").value;
            if(hireName==""){
              alert('招聘标题不能为空！');
		     }
		     if(hireTime==""){
		     ...
		     if(hireExplain==""){
		      ...
		      document.getElementById("form2").action="wAbout_HireUpdate?id=<%=hireImpl.getId()%>";
