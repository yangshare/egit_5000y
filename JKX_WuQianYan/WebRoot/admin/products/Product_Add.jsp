...
.css_td {
  ...
  if(request.getParameter("insert")!=null){
    ...
    out.print("<script>alert('新增产品失败！');</script>");
    }
    if(request.getParameter("insert").equals("rename")){
    out.print("<script>alert('产品名重名，请重命名！');</script>");
    }
  }
  ...
  <body> 
   ...
   <tr bgcolor="#eef9e1">
   <td height="20" class="css_td">
           产品名：
   <input type="text" id="productName" name="productName" class="input_01" value=""/>
   </td>
   </tr>
    ...
    if(document.getElementById("typeText").value!=""){
       ...
       if(bool==true){
            if(caseName!="" && caseContent!=undefined){
              document.getElementById("form2").action="wProduct_insert";
