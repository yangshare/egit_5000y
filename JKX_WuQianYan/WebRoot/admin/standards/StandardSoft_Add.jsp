...
.css_td {
  ...
  <body> 
   ...
   <td height="15" class="css_td">
           案例名：
   <input type="text" id="standardName" name="standardName" class="input_01" value=""/>
   </td>
   </tr>
    ...
    window.onload = function(){
     ...
     function submi(){
       ...
       var standardName=document.getElementById("standardName").value;
            ...
            if(standardName!="" && standardContent!=""){
              document.getElementById("form2").action="wStandard_StandardSoftInsert";
