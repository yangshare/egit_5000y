...
<html>
  <head>
   <base href="<%=basePath%>">
	...
	<link rel="stylesheet" type="text/css" href="wService/wService.css">
  </head>
...
<!-- END header -->
  	<div style="margin:10px;margin-left:315px;">
  		<img alt="contacts" src="img/wService/service.jpg">
  	</div>
    <div class="Yindex">
    	<div class="Yleft float">
    		<ul>
    			<li>服务流程</li>
    	...
    	<div class="Yright float">
    		<img alt="加载中" src="img/wService/services.png"/>
    	</div>
    </div>
     <!-- footer -->	
