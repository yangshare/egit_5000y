	  ...
	  $.ajax({
                ...
                success:function (data){
					...
					for(var i=0;i<data.json.length;i++){
					 ...
					 caseContent+='<li  style="border-bottom:2px solid #c40e24"><a href="product.html" >ALL</a></li></ul></span></center>';
